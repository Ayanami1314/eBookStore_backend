...
INSERT INTO Books (title, author, price, isbn, description, sales, cover)
VALUES ('The Great Gatsby', 'F. Scott Fitzgerald', 2000, '978-0743273565', 'The story of the mysteriously wealthy Jay Gatsby and his love for the beautiful Daisy Buchanan.', 0, '/resources/images/TheGreatGatsby.png');

INSERT INTO Books (title, author, price, isbn, description, sales, cover)
VALUES ('Moby Dick', 'Herman Melville', 2500, '978-1503280786', 'The sailor Ishmael narrates the obsessive quest of Ahab, captain of the whaling ship Pequod, for revenge on Moby Dick.', 0, '/resources/images/mobydick.jpg');
